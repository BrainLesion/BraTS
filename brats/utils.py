...
def check_model_weights(record_id: str) -> Path:
    ...
    zenodo_metadata = _get_zenodo_metadata(record_id=record_id)
    ...
    if not latest_downloaded_weights:
        ...
        return _download_model_weights(
            zenodo_metadata=zenodo_metadata, record_id=record_id
        )
    ...
    return _download_model_weights(zenodo_metadata=zenodo_metadata, record_id=record_id)
...
def _get_zenodo_metadata(record_id: str) -> Dict | None:
...
def _download_model_weights(zenodo_metadata: Dict, record_id: str) -> Path:
