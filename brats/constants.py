...
class AdultGliomaPreAndPostTreatmentAlgorithms(Algorithms):
    ...
    """ BraTS25 Adult Glioma Segmentation 3rd place (tie) """
    BraTS25_CNMC_PAI = "BraTS25_CNMC_PAI"
    """ BraTS25 Adult Glioma Segmentation CNMC_PAI baseline """
...
class MeningiomaRTAlgorithms(Algorithms):
    ...
    BraTS25_CNMC_PAI = "BraTS25_CNMC_PAI"
    """ BraTS25 Meningioma Segmentation CNMC_PAI baseline """
...
class PediatricAlgorithms(Algorithms):
    ...
    BraTS25_CNMC_PAI = "BraTS25_CNMC_PAI"
    """ BraTS25 Pediatric Segmentation CNMC_PAI baseline"""
...
class AfricaAlgorithms(Algorithms):
    ...
    BraTS25_CNMC_PAI = "BraTS25_CNMC_PAI"
    """ BraTS25 BraTS-SSA Segmentation CNMC_PAI baseline """
...
class MetastasesAlgorithms(Algorithms):
    ...
    BraTS25_CNMC_PAI = "BraTS25_CNMC_PAI"
    """BraTS25  Brain Metastases Segmentation CNMC_PAI baseline"""
...
class InpaintingAlgorithms(Algorithms):
    ...
    BraTS25_CNMC_PAI = "BraTS25_CNMC_PAI"
    """ BraTS25  Inpainting CNMC_PAI baseline """
